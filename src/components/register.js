...
//         <span style={{ color: "#db7302" }}>Your first name must be valid</span>
//       );
//     }
...
//         <span style={{ color: "#db7302" }}>Your last name must be valid</span>
//       );
//     }
//     if (this.state.email) {
//       inputError = true;
